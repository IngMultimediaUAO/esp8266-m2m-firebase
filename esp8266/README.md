...
## Identificación de los skecthes:

Hay dos carpetas llamadas `arduino1` y `arduino2`, se sobre entiende que para este proyecto se necesitan dos módulos esp8266 así que el skecth de arduino que se encuentra en la carpeta `arduino1` se le cargará al módulo "A" y el skecth en la carpeta `arduino2` se le cargará al módulo "B".


## Conexiones para que cada esp8266 encienda un led

Existe una carpeta llamada `connections` en dicha carpeta se encuentra el montaje el cual se le debe hacer para cada módulo, con esto cada esp8266 contará con su propio led.


## Modificaciones en los skecth de arduino

Se deben modificar las siguientes variables en los sketches de arduino:

* FIREBASE_HOST "id-del-proyecto.firebaseio.com"
* FIREBASE_AUTH "token-o-secret-del-proyecto"
* WIFI_SSID "nombre-red-wifi"
* WIFI_PASSWORD "password-red-wifi"
